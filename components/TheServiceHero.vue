<template>
  <section class="mx-auto bg-my-lightOrange text-my-darkBlue rounded w-full md:w-full ">
    <div class="grid max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:py-10 lg:grid-cols-12 ">
