<template>
  <section class="mx-auto bg-my-lightOrange text-my-darkBlue rounded max-w-screen h-full ">
    <div class="grid max-w-screen-xl px-4 py-2 mx-auto lg:gap-8 xl:gap-0 lg:py-12 lg:grid-cols-12">
